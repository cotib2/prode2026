...
export default function PartidoCard({ partido, userId, votoInicial, formatearFecha }) {
  const [goles1, setGoles1] = useState('')
  const [goles2, setGoles2] = useState('')

  const [guardando, setGuardando] = useState(false)

  const [golesGuardados, setGolesGuardados] = useState(votoInicial ? {
  ...
  const esVotoIdenticoAGuardado = golesGuardados !== null && 
