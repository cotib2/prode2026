...
class FootballAPIService:
    ...
    def obtener_fixture_mundial(self):
        ...
        for match in matches:
            ...
            # Elegimos el bloque de goles según la duración del partido
            duration = score_data.get("duration")
            if duration in ("EXTRA_TIME", "PENALTY_SHOOTOUT"):
                score_block = score_data.get("extraTime") or {}
            else:
                score_block = score_data.get("fullTime") or {}
            ...
            partido = {
                ...
                "goles_real_1": score_block.get("home"),
                "goles_real_2": score_block.get("away"),
